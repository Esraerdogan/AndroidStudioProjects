package com.erdoganesra.workmanagerjava;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase(int myNumber){
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.erdoganesra.workmanagerjava",Context.MODE_PRIVATE);
